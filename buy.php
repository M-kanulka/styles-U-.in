...
<div id="right">
<h1>You have chosen <?php echo $_GET['product']." ".$_GET['category']; ?> to buy</h1>
...
echo '<a href="" class="buy">Price:'.$row['price'] . '</a></div>';
echo '<div id="features" style="height:auto;"><h1> billing details </h1>
<form method="post" action="buy2.php?product='.$row['name'].'">
