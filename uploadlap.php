...
$path="images/lappys home/".$name;
$sql="INSERT INTO laptop (brand,path,name,price,feature1,feature2,feature3)
VALUES
...
move_uploaded_file($_FILES["path"]["tmp_name"],"images/lappys home/" . $_FILES["path"]["name"]);
...
echo '<a href="uploadlap.html">go back</a>';
